...
summaryDct = {
  "p1":"Experienced Co-Founder with a demonstrated history of working in the information technology and services industry. Skilled in Python, SQL, Pandas, Numpy, Sympy and Command Line. Professional with a Bachelor's degree focused in Data Science and Artiﬁcial Intelligence from IESB.",
  "p2":"Interested in AWS tools, Spark, Airﬂow, PostgreSQL, No-SQL, Docker, ETL, Scrap, CLI, Django and becoming an expert in Python.",
}
...
experienceB ={
  "position" :  "President of the junior enterprise.",
  "place" :  "DatAí",
  "finished" :  "April 2022",
  "started" :  "July 2021",
